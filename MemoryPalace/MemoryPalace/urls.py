...
urlpatterns = [
    ...
    url(r'.*deleteRoomImageObject/', 'coreapp.views.deleteRoomImageObject', name='deleteRoomImageObject'),
    url(r'.*deletePalaceImageObject/', 'coreapp.views.deletePalaceImageObject', name='deletePalaceObject'),
